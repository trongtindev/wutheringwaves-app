...
const lastUpdatedOn = moment(item.modifiedTime);
...
<template>
  <div>
    ...
    <!-- Tab views -->
    <div id="overview">
      <characters-sequences :item="item" :data="data" />
      <characters-skills :item :data />
      <characters-voice-actors :item :data />
    </div>

    <div id="build">
      <characters-skill-priority :item :data />
      <characters-best-weapons :item :data :weapons />
      <characters-best-echo-sets :item :data :echoes />
      <characters-best-echo-stats :item :data :echoes />
      <characters-best-main-echoes :item :data :echoes />
    </div>

    <div id="teams">
      <characters-best-teams :item="item" :data="data" />
    </div>

    <characters-ascension :item="item" :data="data" />

    <!-- moreBuildGuides -->
    <characters-more-builds :item :characters />
