...
<template>
  <div
    :style="
      index > 6
        ? `left: ${80 * (index - 7) + 20 * (index - 7) + 20}px; bottom: 140px`
        : `left: ${80 * index + 20 * index + 20}px; bottom: 40px`
    "
    :class="`border-rarity${props.data.rarity}`"
    style="width: 80px; height: 80px"
    cols="2"
    class="border rounded-circle position-absolute"
  >
